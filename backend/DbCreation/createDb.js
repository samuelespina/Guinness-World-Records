...
const progLanguageInsertInto = () => {
  fs.readFile("./DbInsertInTo/progLanguages.txt", "utf8", (err, dbData) => {
    if (err) return err;
...
const progLanguageUsagesInsertInto = () => {
  fs.readFile("./DbInsertInTo/progLanguageUsage.txt", "utf8", (err, dbData) => {
    if (err) return err;
    progDiary.query(dbData, (err, data) => {
      if (err) console.log(err);
    });
...
const statisticsInsertInto = () => {
  fs.readFile("./DbInsertInTo/statistics.txt", "utf8", (err, dbData) => {
    if (err) return err;
    progDiary.query(dbData, (err, data) => {
      if (err) console.log(err);
    });
...
const languagesUsagesInsertInto = () => {
  fs.readFile("./DbInsertInTo/languages_usages.txt", "utf-8", (err, dbData) => {
    if (err) return err;
    progDiary.query(dbData, (err, data) => {
      if (err) console.log(err);
    });
